...
time.sleep(3)  # do work every 55 seconddt


dateTimeObj2 = datetime.now()

dif = dateTimeObj2 - dateTimeObj 

print(dateTimeObj2.second)
print(dif)
print(dif.seconds)
print(type(dif))
# print(timedelta.seconds(dif))
9
# print(int(dif))
# dateTimeObj = datetime.now()

# # time.sleep(0:00:06.1997)
